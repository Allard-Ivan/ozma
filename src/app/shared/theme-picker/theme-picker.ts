...
import { ThemeStorage, PortalSiteTheme } from './theme-storage/theme-storage';
import {
...
export class ThemePicker {
  ...
  installTheme(theme: PortalSiteTheme) {
  ...
  private _getCurrentThemeFromHref(href: string): PortalSiteTheme {
